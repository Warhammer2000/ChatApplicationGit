...
namespace ChatApplication.Controllers
{
    public class AddressBookController : Controller
    {
		...
		public AddressBookController(ApplicationDbContext context, UserManager<ApplicationUser> userManager)
		{
			_context = context;
